...
Existen diversas funciones para crear vértices, dependiendo de si se quieren utilizar números flotantes o enteros, y si se quieren utilizar tres dimensiones o sólo dos. Esas funciones son las siguientes.
\begin{lstlisting}[language=C]
...
\end{lstlisting}
\subsection{Finalización de la estructura gráfica}
