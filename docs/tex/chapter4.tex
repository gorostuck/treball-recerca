...
El espacio local es en el que se definen las coordenadas de los vértices, normales, etc. Antes de que cualquier transformación ocurra. Estas coordenadas/normales se multiplicarán por la matriz VM y pasarán al espacio de vista.
\section{Nodos}
